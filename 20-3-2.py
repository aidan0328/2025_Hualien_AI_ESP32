...
# 對方 (Peer) 的 MAC 地址
peer_mac_bytes = ubinascii.unhexlify(mac_esp1_str.replace(':', ''))


# --- 初始化 ESP-NOW ---

print("實驗 #20-3-2: ESP32 #2 啟動中...")
...
print("--- 初始化完成 ---")
print("本機 (ESP32 #2) MAC 地址: ", my_mac_str)
print("對方 (ESP32 #1) MAC 地址: ", mac_esp1_str)
print("--------------------")
